...
const schemas = {
  ...
  collections: {},
  pagination: {},
  exclusion: Object.keys(contentTypes).filter(contentType => contentTypes[contentType].createPage === false).map(contentType => contentTypes[contentType].slug.plural)
}
...
Object.keys(contentTypes).forEach((contentTypeId) => {
  ...
  if (contentType.collection !== false) {
